...
__all__ = ["Category", "Course", "CourseDetail", "Teacher", "DegreeCourse", "CourseChapter",
           "CourseSection", "PricePolicy", "OftenAskedQuestion", "Comment", "Account", "CourseOutline","Coupon","CouponRecord"]
...
class Account(models.Model):
    ...
    pwd=models.CharField(max_length=128,default=123,verbose_name='密码')
    token=models.UUIDField(null=True,blank=True)
    token_create_time=models.DateTimeField(auto_now=True)
